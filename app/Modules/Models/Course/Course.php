...
class Course extends Model
{
    ...
    protected $fillable = [
        'category_id', 'sub_category_id', 'title', 'slug', 'caption', 'description', 'duration', 'study_option',
        ...
        'is_featured', 'is_program', 'is_affiliated', 'is_continious', 'image', 'secondary_image', 'banner_image', 'icon_image',

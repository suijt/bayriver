                ...
                <form method="POST" class="form" action="{{route('admin.login')}}">
                    ...
                    <div class="text-center mb-10">
                        ...
                        <div class="text-gray-400 fw-bold fs-4">Forgot your password?
                            <a href="{{ route('password.request') }}" class="link-primary fw-bolder">Reset here</a>.
                        </div>
                        <!--end::Link-->
                    </div>
                    <!--begin::Heading-->
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <input class="form-control form-control-solid" placeholder="Enter your username" type="text" placeholder="" name="username" autocomplete="off" />
                        @error('username')
                    ...
                    <div class="mb-7 fv-row" data-kt-password-meter="true">
                        ...
                        <div class="mb-1">
                            ...
                            <div class="position-relative mb-3">
                                <input class="form-control form-control-solid" placeholder="Enter yout password" type="password" placeholder="" name="password" autocomplete="off" />

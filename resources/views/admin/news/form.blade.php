            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Title" name="title" value="@if(isset($news)){{$news->title}}@else{{old('title')}}@endif" required />
                        @error('title')
                ...
                <div class="form-group row mt-5">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('caption') is-invalid @enderror" placeholder="Enter short description" name=" caption" value="@if(isset($news)){{$news->caption}}@else{{old('caption')}}@endif" required />
                        @error('caption')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group row mt-5">
                    <div class="col">
                        ...
                        <textarea id="kt_docs_tinymce_basic" name="description" class="tox-target">@if(isset($news)){{$news->description}}@else{{old('description')}}@endif</textarea>
                        @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="card card-custom sticky" data-sticky="true" data-margin-top="140" data-sticky-for="1023" data-sticky-class="stickyjs">
            <div class="card-body">
                    ...
                    <div class="col-6">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input" name="is_featured" type="checkbox" {{ old('is_featured',
                                isset($news->is_featured) ?
                            $news->is_featured : '' )=='yes' ? 'checked' :'' }} />
                        </label>
                    </div>
                </div>
                <div class="form-group row mt-5">
                    <label class="col-6 ">Headline</label>
                    <div class="col-6">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input" name="is_headline" type="checkbox" {{ old('is_headline',
                                isset($news->is_headline) ?
                            $news->is_headline : '' )=='yes' ? 'checked' :'' }} />
                        </label>
                    </div>
                </div>
                <div class="form-group row mt-5">
                    <label class="col-6 ">Is Event</label>
                    <div class="col-6">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input class="form-check-input" name="is_event" type="checkbox" {{ old('is_event',
                                isset($news->is_event) ?
                            $news->is_event : '' )=='yes' ? 'checked' :'' }} />
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group row mt-5">
                    ...
                    <div class="col-6">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input type="number" min="1" class="form-control @error('order') is-invalid @enderror" placeholder="Order" name="order" value="@if(isset($news)){{$news->order}}@else{{old('order')}}@endif" required />
                        </label>
                    </div>
                </div>
                <div class="form-group row mt-5">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div class="image-input image-input-circle" data-kt-image-input="true" style="background-image: url({{asset('assets/admin/media/svg/avatars/007-boy-2.svg')}})">
                            ...
                            <div class="image-input-wrapper w-125px h-125px" @if(isset($news->image))
                                style="background-image:url({{asset($news->image_path) }})"
                                @endif></div>

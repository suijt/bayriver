...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div class="d-flex align-items-center py-1">
            <!--begin::Button-->
            <a href="{{route('admin.page.create')}}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create New Record</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
    </div>
...
<div class="d-flex flex-column-fluid">
    ...
    <div class="container">
        <div class="card card-custom">
            ...
            <div class="card-body">
                <!--begin: Datatable-->
                <table class="table table-separate table-head-custom table-checkable" id="pageData">
                    <thead>
                        <tr>

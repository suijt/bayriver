            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Category Name" name="name" value="@if(isset($category)){{$category->name}}@else{{old('name')}}@endif" required />
                        @error('name')
                ...
                <!-- <div class="form-group row mt-5">
                    <div class="col">
                        ...
                        <textarea id="kt_docs_tinymce_basic" name="description" class="tox-target">@if(isset($category)){{$category->description}}@else{{old('description')}}@endif</textarea>
                        @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="card card-custom sticky" data-sticky="true" data-margin-top="140" data-sticky-for="1023" data-sticky-class="stickyjs">
            <div class="card-body">
                ...
                <div class="form-group row mt-5">
                    ...
                    <div class="col-6">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input type="number" min="1" class="form-control @error('order') is-invalid @enderror" placeholder="Order" name="order" value="@if(isset($category)){{$category->order}}@else{{old('order')}}@endif" required />
                        </label>
                    </div>
                </div>
                {{--<div class="form-group row mt-5">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div class="image-input image-input-circle" data-kt-image-input="true" style="background-image: url({{asset('assets/admin/media/svg/avatars/007-boy-2.svg')}})">
                            ...
                            <div class="image-input-wrapper w-125px h-125px" @if(isset($category->image))

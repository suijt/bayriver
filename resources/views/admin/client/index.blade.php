...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
            ...
            <li class="breadcrumb-item text-muted">
                <a href="{{ route('admin.client.index')}}" class="text-muted">Client</a>
            </li>
        ...
        <div class="d-flex align-items-center py-1">
            <!--begin::Button-->
            <a href="{{route('admin.client.create')}}" class="btn btn-sm btn-primary" id="kt_toolbar_primary_button">Create New Record</a>
            <!--end::Button-->
        </div>
        <!--end::Actions-->
    </div>
                ...
                <table class="table table-separate table-head-custom table-checkable" id="tableData">
                    <thead>
                        <tr>
                            ...
                            <th class="notexport">Client Name</th>
                            <th>Status</th>

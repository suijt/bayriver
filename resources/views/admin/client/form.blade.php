            ...
            <div class="card-body">
                <div class="form-group row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Enter Client Title" name="title" value="@if(isset($client)){{$client->title}}@else{{old('title')}}@endif" required />
                        @error('title')
                ...
                <div class="form-group row mt-5">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('caption') is-invalid @enderror" placeholder="Enter Client Title" name="caption" value="@if(isset($client)){{$client->caption}}@else{{old('caption')}}@endif" required />
                        @error('caption')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <div class="card card-custom sticky" data-sticky="true" data-margin-top="140" data-sticky-for="1023" data-sticky-class="stickyjs">
            <div class="card-body">
                ...
                <div class="form-group row mt-5">
                    ...
                    <div class="col-6">
                        <label class="form-check form-switch form-check-custom form-check-solid">
                            <input type="number" min="1" class="form-control @error('order') is-invalid @enderror" placeholder="Order" name="order" value="@if(isset($client)){{$client->order}}@else{{old('order')}}@endif" required />
                        </label>
                    </div>
                </div>
                <div class="form-group row mt-5">
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div class="image-input image-input-circle" data-kt-image-input="true" style="background-image: url({{asset('assets/admin/media/svg/avatars/007-boy-2.svg')}})">
                            ...
                            <div class="image-input-wrapper w-125px h-125px" @if(isset($client->image))
                                style="background-image:url({{asset($client->image_path) }})"
                                @endif></div>

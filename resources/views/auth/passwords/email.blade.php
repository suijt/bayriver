            ...
            <div class="d-flex flex-center p-15 shadow rounded w-100 w-md-550px mx-auto ms-xl-20">
                ...
                <form method="POST" class="form" action="{{ route('password.email') }}">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <input class="form-control form-control-solid @error('email') is-invalid @enderror" id="email" placeholder="Enter your email address" type="email" placeholder="" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus />
                        @error('email')
